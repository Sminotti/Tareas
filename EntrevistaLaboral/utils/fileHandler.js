...
const deleteTemp = (file) => fs.unlink(file, (e) => console.log(e));//funcion que borra el temporal//fs.unlink(archivo),permite manejar el archivo
// mimetype
//gurada el archivo
...
const saveFile = ({ mimetype, size, path },allowE,destFolder = `./public/images`) => {
  try {
    ...
    return fileName;// retorna el archivo renombrad y creado en imagen
  } catch (e) {
